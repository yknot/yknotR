#' A Scatter Plot function with ggplot2
#'
#' Creates scatter plot using ggplot2 and saves it as png in current directory
...
#' @export
#' @examples
#' yknot.scatter(iris, "Sepal.Length", "Sepal.Width", "Species", "Sepal Comparison", "Sepal Length", "Sepal Width", "Test")


yknot.scatter <- function(df, x, y, fill, title, xlab, ylab, filename) {
